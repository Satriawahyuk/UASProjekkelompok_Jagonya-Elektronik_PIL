...
import 'package:flutter_jago_elektronik/app/modules/admin/controllers/add_partner_controller.dart';

class AddPartnerView extends GetView<AddPartnerController> {
  const AddPartnerView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: TextFormat(
          "${(controller.sData == null) ? "Tambah" : "Perbarui"} Mitra",
          34.sp,
              ...
              children: [
                ...
                if (controller.sData != null)
                  ActionButton(
                    ...
                    minimumSize: Size(0.9.sw, 80.h),
                    onTap: () => controller.deletePartner(),
                  ),
              ],
            ),
          ],
  ...
  Widget inputPhotoWidget() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: GetBuilder<AddPartnerController>(
