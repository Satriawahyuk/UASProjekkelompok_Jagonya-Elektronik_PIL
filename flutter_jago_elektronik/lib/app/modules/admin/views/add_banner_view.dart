...
import 'package:flutter_jago_elektronik/app/modules/admin/controllers/add_banner_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: TextFormat(
          "${(controller.sData == null) ? "Tambah" : "Perbarui"} Banner",
          34.sp,
  ...
  Widget inputPhotoWidget() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: GetBuilder<AddBannerController>(
